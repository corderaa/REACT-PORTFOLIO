        ...
        <div className="flex flex-col h-fit mt-20 text-center">
            ...
            <div className="grid grid-cols-3 max-[1212px]:grid-cols-1 gap-20 justify-items-center mt-28 z-30">
                <div className="grid-container p-10">
                    ...
                    <a href="https://www.elorrieta.eus/"><img src="https://www.elorrieta.eus/wp-content/uploads/2021/07/EEM-logo-color.svg" className="max-[900px]:invisible mt-12"/></a>
                </div>
                <div className="grid-container p-10 flex flex-col items-center">
                    ...
                    <img className="max-[900px]:invisible w-28 mt-10" src="https://cdn4.iconfinder.com/data/icons/logos-3/600/React.js_logo-512.png"/>
                </div>
                <div className="grid-container p-10 flex flex-col items-center">
                    ...
                    <img className="max-[900px]:invisible" src="https://kotlinlang.org/docs/images/kotlin-logo.png"/>
                </div>
            </div>  
        </div>
    );
